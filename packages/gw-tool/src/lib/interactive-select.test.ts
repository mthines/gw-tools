...
Deno.test(
  "multiSelect - returns empty on immediate enter",
  async () => {
...
Deno.test(
  "multiSelect - space toggles item and enter confirms",
  async () => {
...
Deno.test(
  "multiSelect - disabled items are skipped by cursor",
  async () => {
...
Deno.test(
  "multiSelect - space on section header toggles all items",
  async () => {
...
Deno.test(
  "multiSelect - 'a' key toggles all in current section",
  async () => {
...
Deno.test(
  "multiSelect - toggle all twice deselects all",
  async () => {
...
Deno.test(
  "multiSelect - protected items can be selected",
  async () => {
...
Deno.test(
  "multiSelect - returns empty for empty sections",
  async () => {
    const result = await multiSelect(
      {
        message: "Test",
...
Deno.test(
  "multiSelect - throws for non-TTY environment",
  async () => {
    const io: TerminalIO = {
    ...
    try {
      await multiSelect(
        { message: "Test", sections: createTestSections() },
        io,
      );
    } catch (e) {
      threw = true;
      assertEquals(
        (e as Error).message.includes("terminal"),
        true,
      );
    }
...
Deno.test(
  "multiSelect - pre-selected items are included",
  async () => {
...
Deno.test(
  "multiSelect - warning banner is rendered",
  async () => {
    const keys = encodeKeys("enter");
...
Deno.test(
  "multiSelect - multiple items across sections",
  async () => {
