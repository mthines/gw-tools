...
function parseInitArgs(args: string[]): {
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    if (arg === '--help' || arg === '-h') {
      ...
      // --pre-add is kept as silent backwards compat alias
      ...
      // --post-add is kept as silent backwards compat alias
...
Options:
  ...
  --auto-clean                    Prompt to cleanup stale worktrees (after checkout/list, 24h cooldown)
