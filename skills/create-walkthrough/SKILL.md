...
description: >
  Generate a walkthrough artifact (walkthrough.md) summarizing completed work for PR delivery.
  Gathers information from plan.md, git history, and test results to produce a comprehensive
  summary. Use at Phase 6 before creating the draft PR.
...
1. **File** — saved to `.gw/{branch-name}/walkthrough.md` for reference and handoff
